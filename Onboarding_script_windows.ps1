...
try {
    ...
    $env:SUBSCRIPTION_ID = "97dc82f4-458e-4ff1-a935-2b799d2082f6";
    $env:RESOURCE_GROUP = "ArcBox";
    $env:TENANT_ID = "4cfe372a-37a4-44f8-91b2-5faf34253c62";
    $env:LOCATION = "centralus";
    $env:AUTH_TYPE = "principal";
    $env:CORRELATION_ID = "9c682338-657d-45aa-9a03-898ccb90f4f3";
